var alexanderHamilton = {
  ...
  lyrics:`
    ...
    <br>By being a self-starter
    <br>By fourteen, they placed him in charge of a
    <br>Trading charter
    <br><br>
    ...
    <br>Without a cent of restitution
    <br>Started workin', clerkin' for his late mother's landlord
    <br>Tradin' sugar cane and rum and all the things he can't afford
    <br>Scammin' for every book he can get his hands on
    <br>Plannin' for the future see him now as he stands on
    <br>The bow of a ship headed for a new land
    ...
    <br>You could never back down
    <br>You never learned to take your time!
    <br>
    <br>Oh, Alexander Hamilton
    
    <br>When America sings for you
    <br>Will they know what you overcame?
    <br>Will they know you rewrote the game?
    ...
    <br>Another immigrant
    <br>Comin' up from the bottom
    
    <br>His enemies destroyed his rep
...
var aaronBurrSir = {
  ...
  lyrics:`
    ...
    <br>Those redcoats don't want it with me!
    ...
    <br>Tell the King "Casse toi!" Who's the best?
    <br>C'est moi!
    <br><br>
...
var myShot = {
  ...
  lyrics:`
    ...
    <br>The plan is to fan this spark into a flame
    <br>But dang, it's getting dark, so let me spell out the name
    <br>I am the-
    <br><br>
    ...
    <br>So there will be a revolution in this century
    <br>Enter me!
    <br><br>
    ...
    <br>To socially advance, instead of sewin' some pants!
    <br>I'm gonna take a-
    <br><br>
    ...
    <br>On a stallion with the first black battalion
    <br>Have another-
    <br><br>
    ...
    <br>You've got to be carefully taught:
    ...
    <br>Laurens, I like you a lot
    <br>Let's hatch a plot blacker than the kettle callin' the pot...
    <br>What are the odds the gods would put us all in one spot
    ...
    <br>If I see it comin', do I run or do I let it be?
    <br>Is it like a beat without a melody?
    <br>See, I never thought I'd live past twenty
    ...
    <br>Foes oppose us, we take an honest stand
    <br>We roll like Moses, claimin' our promised land
    <br>And? If we win our independence?
    <br>Is that a guarantee of freedom for our descendants?
    ...
    <br>I'm past patiently waitin'. I'm passionately
    <br>Smashin' every expectation
    <br>Every action's an act of creation!
    <br>I'm laughin' in the face of casualties and sorrow
    ...
    Oh, yeah, it's time to take a shot
    <br>Time to take a shot
